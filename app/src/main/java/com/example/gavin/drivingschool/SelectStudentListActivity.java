...
/**
 * Created by gavin on 2017/06/29.
 */
public class SelectStudentListActivity extends AppCompatActivity {
...
*/
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(SelectStudentListActivity.this, ViewClientActivity.class);
    ...
    private void selectItemFromDrawer(int position) {
        ...
        switch (position){
            case 0:
                startActivity(new Intent(SelectStudentListActivity.this, AppointmentListActivity.class));
                mDrawerLayout.closeDrawers();
                break;
            case 1:
                startActivity(new Intent(SelectStudentListActivity.this, UserListActivity.class));
                break;
            case 2:
                startActivity(new Intent(SelectStudentListActivity.this, ClientListActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 3:
                startActivity(new Intent(SelectStudentListActivity.this, CarListActivity.class));
                break;
            case 4:
                startActivity(new Intent(SelectStudentListActivity.this, ScoreListActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 5:
                sess.logoutUser();
