...
/**
 * Created by gavin on 2017/06/28.
 */
...
SessionManagerHelper sess;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.scorelist_activity);
            ...
            fab = (FloatingActionButton) findViewById(R.id.createNewScore);
...
*/
            ...
            newsItems = service.getAllScore();
            int AlleyDockingLeft = 4;
            int AlleyDockingRight = 2;
            int ParallelParkingLeft = 7;
            int ParallelParkingRight = 5;
            int ThreePointTurn = 4;
            int Driving = 6;
            int LessonNumber = 1;

            Score user = new Score.Builder()

                    .AlleyDockingLeft(AlleyDockingLeft)
                    .AlleyDockingRight(AlleyDockingRight)
                    .ParallelParkingLeft(ParallelParkingLeft)
                    .ParallelParkingRight(ParallelParkingRight)
                    .ThreePointTurn(ThreePointTurn)
                    .Driving(Driving)
                    .LessonNumber(LessonNumber)
                    .build();
            service.addScore(user);
            if(newsItems.size() == 0)
            {
                newsItems.add(user);
            }
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Score clickStory = newsItems.get(+position);
                    System.out.println("story id "+ clickStory.getId());
                    Intent i = new Intent(ScoreListActivity.this, ViewScoreActivity.class);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(ScoreListActivity.this, ScoreActivity.class));
        ...
        private void selectItemFromDrawer(int position) {
            ...
            switch (position){
                case 0:
                    startActivity(new Intent(ScoreListActivity.this, AppointmentListActivity.class));
                    mDrawerLayout.closeDrawers();
                    break;
                case 1:
                    startActivity(new Intent(ScoreListActivity.this, UserListActivity.class));
                    break;
                case 2:
                    startActivity(new Intent(ScoreListActivity.this, ClientListActivity.class));
                    //  mDrawerLayout.closeDrawers();
                    break;
                case 3:
                    startActivity(new Intent(ScoreListActivity.this, CarListActivity.class));
                    break;
                case 4:
                    startActivity(new Intent(ScoreListActivity.this, ScoreListActivity.class));
                    //  mDrawerLayout.closeDrawers();
                    break;
                case 5:
                    sess.logoutUser();
