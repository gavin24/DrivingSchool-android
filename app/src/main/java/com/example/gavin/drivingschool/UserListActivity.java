...
*/
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(UserListActivity.this, ViewClientActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(UserListActivity.this, ClientActivity.class));
    ...
    private void selectItemFromDrawer(int position) {
        ...
        switch (position){
            case 0:
                startActivity(new Intent(UserListActivity.this, AppointmentListActivity.class));
            ...
            case 1:
                ...
                break;
            case 2:
                startActivity(new Intent(UserListActivity.this, ClientListActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 3:
                startActivity(new Intent(UserListActivity.this, CarListActivity.class));
                break;
            case 4:
                startActivity(new Intent(UserListActivity.this, ScoreListActivity.class));
                //  mDrawerLayout.closeDrawers();
                break;
            case 5:
                sess.logoutUser();
